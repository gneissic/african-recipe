...
const BotswanaFood = () => {
  ...
  return (
    <Fragment>
      ...
      {isLoading && (
        <p className="text-1xl mx-auto mt-[10rem] max-w-[70vw] animate-pulse overflow-hidden text-center font-semibold text-slate-700 sm:text-2xl lg:text-3xl">
          Loading your meals.....
        </p>
      )}
    </Fragment>
